...
![Alt text](RHPStarWars.png?raw=true "Title")
![Alt text](LHPStarWars.png?raw=true "Title")
![Alt text](RHPTerry'sHand.png?raw=true "Title")

When the program is opened a start screen appears with the Star Wars theme tune.

![Alt text](StartScreen.png?raw=true "Title")

When the right hand is opened a get ready screen appears for about 3 seconds.

![Alt text](GetReadyScreen.png?raw=true "Title")
...
![Alt text](GamePlayScreen.png?raw=true "Title")

![Alt text](SpasticityGame.png?raw=true "Title")
